...
orf_count = dict(zip(orf, all)) #create a dictionary of ORFs
...
plt.plot(x_line, y_con, '-', color='red')
...
plt.plot(x_line, y_Rec, '-', color='red')
...
plt.plot(x_line, y_Exc, '-', color='red')
...
plt.plot(x_line, y_Reg, '-', color='red')
...
plt.plot(x_line, y_tetM, '-', color='red')
